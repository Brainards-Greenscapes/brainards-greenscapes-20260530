...
export default function (eleventyConfig) {
  ...
  eleventyConfig.addFilter("breadcrumbJsonLd", function (pageUrl, siteUrl) {
    ...
    const nameMap = {
      ...
      "portfolio": "Portfolio",
      "projects": "Projects",
      "tree-removal-flagstone-patio": "Hazard Tree Removal & Flagstone Patio Rebuild",
      "drainage-channel": "Erosion-Control Drainage Channel",
      "backyard-xeriscape": "Mature Backyard Xeriscape",
      "about": "About",
      "contact": "Contact",
